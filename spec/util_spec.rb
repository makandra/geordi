RSpec.describe Geordi::Util do
  ...
  describe '.relevant_linear_commit_messages' do
    it 'returns all commits starting with any given linear issue id' do
      ...
      expect(described_class.relevant_linear_commit_messages(commit_messages, relevant_ids)).to eq  ["[W-365] Linear Issue Commit", "[W-366] Linear Issue Commit 2"]
    end
  end
